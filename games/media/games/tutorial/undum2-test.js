...
undum.game.id = "B8375571-FAD0-4271-A5CC-8CFC209E7F6B";
...
undum.game.situations = {
    ...
    room1: new undum.SimpleSituation(
        "<p>This is an alternative situation for the first one. You can go \
        to the actual one next.</p>",
        {
            optionText: "Next (alternate)",
            tags: "room",
            choices: ["rooms"]
        }
    ),
