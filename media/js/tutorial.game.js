...
undum.game.situations = {
    start: new undum.ActionSituation(
        "<img src='media/tutorial/woodcut.png' class='float_right'>\
         ...
         that). This text was generated by\
         the <em>enter</em> method of the first situation.<p>\
         \
         <p>Two things happen in a situation. You either\
         <a href='leave'>leave</a> the situation and enter another one, or\
         you carry out some <a href='./act'>action</a>. Actions may perform\
         some processing, they may display some results, but\
         ultimately they put you back into the same situation\
         again.</p>\
         \
         <p class='transient'>Because I added the\
         <em>transient</em> CSS class to this paragraph when I generated it\
         (all output is just HTML) the whole paragraph is removed when you\
         leave this situation. This is normally used to wrap paragraphs with\
         lots of options ('you could do this... or that...')\
         This makes your history in the game more \
         pleasing to read as a narrative. If you don't want that, don't use \
         <em>transient</em>, it is completely optional.</p>\
         \
         <p> To stop \
         the player using links from old situations, you'll also notice \
         that the links in the second paragraph turn into plain text \
         when you <a href='leave'>leave</a> (you can stop this behavior by \
         giving a link the <em>sticky</em> CSS class - particularly useful \
         for offsite links). <span class='transient'>So what now? You could\
         ...
         Or you could <a href='leave'>go to the next situation</a>.</span>\
         </p>",
